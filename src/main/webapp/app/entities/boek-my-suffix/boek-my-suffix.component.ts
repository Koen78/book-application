...
export class BoekMySuffixComponent implements OnInit, OnDestroy {
  ...
  transition() {
    this.router.navigate(['/boek-my-suffix'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: IBoekMySuffix) {
    return item.id;
  }
  ...
  protected paginateBoeks(data: IBoekMySuffix[], headers: HttpHeaders) {
