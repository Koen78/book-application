...
public class BoekResource {
     ...
     */
    @GetMapping("/boeks")
    public ResponseEntity<List<BoekDTO>> getAllBoeks(Pageable pageable) {
    ...
    public ResponseEntity<List<BoekDTO>> searchBoeks(@RequestParam String query, Pageable pageable) {
