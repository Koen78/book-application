 ...
 */
@Entity
@Table(name = "kbe_winkel")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "winkel")
public class Winkel extends AbstractAuditingEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((Winkel) o).id);
    }
